...
export default function SellerAlerts() {
  const { state, dispatch } = useApp()
  const notes = state.notes.seller

  const markRead = () => dispatch({ type: 'MARK_READ', payload: { persona: 'seller' } })
    ...
    <div className="px-5 pb-8">
      ...
      {notes.length === 0 ? (
        <div className="text-center py-20">
          ...
          <p className="text-muted/60 text-[12px] mt-1">Activity will appear here</p>
        </div>
      ) : (
